...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    /*Your Code Here*/
    let lowerCaseNames = [];
    const getAnimalNames = array.map(function(item){
      return `${item.animal_name}`;
    });
    for(let i = 0; i < getAnimalNames.length; i++){
      lowerCaseNames.push(getAnimalNames[i].toLowerCase());
    }
  ...
  */
  ...
  function USApop(array){
    /*Your Code Here*/
    const totalAnimalPop = array.reduce(function(accumulator, item){
      console.log(`I am the accumulator ${accumulator}`);
      console.log(`I am the item population ${item.population}`);
